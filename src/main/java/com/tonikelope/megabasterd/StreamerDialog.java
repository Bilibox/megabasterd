...
public class StreamerDialog extends javax.swing.JDialog implements ClipboardChangeObserver {
        ...
        if (_main_panel.isUse_mega_account_down() && _main_panel.getMega_accounts().size() > 0) {
            ...
            THREAD_POOL.execute(() -> {
                swingInvoke(() -> {
                    ...
                    _main_panel.getMega_accounts().keySet().stream().filter((k) -> (!mega_default_down.equals(k)))
                            .forEachOrdered((k) -> {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        ...
                        layout.createSequentialGroup().addComponent(use_mega_account_down_label)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(use_mega_account_down_combobox, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE)
                                .addGap(18, 18, 18).addComponent(dance_button))
                        .addComponent(put_label, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(original_link_textfield, javax.swing.GroupLayout.PREFERRED_SIZE, 1000,
                                javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap()
                        .addComponent(put_label).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(original_link_textfield, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED,
                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(dance_button)
                                .addComponent(use_mega_account_down_combobox, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        try {
            ...
            if (link.length() > 0) {
                ...
                try {
                    ...
                    if (findFirstRegex("://enc", link, 0) != null) {
                        ...
                        HashSet links = CryptTools.decryptELC(link,
                                ((MainPanelView) tthis.getParent()).getMain_panel());
                ...
                if (findFirstRegex("://mega(\\.co)?\\.nz/#[^fF]", link, 0) != null
                        || findFirstRegex("https?://[^/]+/![^!]+![0-9a-fA-F]+", link, 0) != null) {

                    String selected_account = (String) use_mega_account_down_combobox.getSelectedItem();

                    data = Bin2UrlBASE64(
                            ((selected_account != null ? selected_account : "") + "|" + link).getBytes("UTF-8"));
            ...
            if (error) {
                ...
                JOptionPane.showMessageDialog(tthis,
                        LabelTranslatorSingleton.getInstance().translate("Please, paste a Mega/MegaCrypter/ELC link!"),
            ...
            if (_main_panel.isUse_mega_account_down() && !"".equals(_selected_item)) {
                ...
                THREAD_POOL.execute(() -> {
                    ...
                    swingInvoke(() -> {
                        ...
                        getDance_button()
                                .setText(LabelTranslatorSingleton.getInstance().translate("Let's dance, baby"));
    ...
    public void notifyClipboardChange() {
        ...
        swingInvoke(() -> {
            String link = extractFirstMegaLinkFromString(
                    extractStringFromClipboardContents(_clipboardspy.getContents()));
