...
public class UploadView extends javax.swing.JPanel implements TransferenceView {
    ...
    public UploadView(Upload upload) {
        ...
        slots_spinner.setModel(
                new SpinnerNumberModel(_upload.getMain_panel().getDefault_slots_up(), MIN_WORKERS, MAX_WORKERS, 1));
        ...
        for (JComponent c : new JComponent[] { queue_up_button, queue_down_button, queue_top_button,
                queue_bottom_button, cbc_label, slots_spinner, slots_label, pause_button, stop_button, speed_label,
                progress_pbar, file_name_label, close_button, restart_button, file_size_label }) {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                        .addComponent(file_size_label, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGap(6, 6, 6).addComponent(folder_link_button)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(layout.createSequentialGroup().addComponent(status_label,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, 446, Short.MAX_VALUE)
                                                        .addGap(18, 18, 18).addComponent(cbc_label)))
                                        .addGap(18, 18, 18).addComponent(slots_label)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(layout.createSequentialGroup().addContainerGap()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(slots_spinner, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(slots_label).addComponent(status_label).addComponent(cbc_label))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(file_name_label).addComponent(slot_status_label))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(folder_link_button).addComponent(file_link_button)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(close_button).addComponent(restart_button))
                                .addComponent(stop_button))
                        .addContainerGap()));
    ...
    public void hideAllExceptStatus() {
        ...
        swingInvokeAndWait(() -> {
            for (JComponent c : new JComponent[] { speed_label, slots_spinner, slots_label, slot_status_label,
                    pause_button, stop_button, progress_pbar, cbc_label }) {
    ...
    public void stop(String status) {
        ...
        swingInvokeAndWait(() -> {
            for (JComponent c : new JComponent[] { pause_button, stop_button, speed_label, slots_label, slots_spinner,
                    progress_pbar, file_name_label, file_size_label }) {
    ...
    public void updateSlotsStatus() {
        ...
        synchronized (_upload.getWorkers_lock()) {
            ...
            conta_error = _upload.getChunkworkers().stream().filter((c) -> (c.isError_wait())).map((_item) -> 1)
