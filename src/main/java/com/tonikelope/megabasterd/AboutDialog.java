...
public class AboutDialog extends javax.swing.JDialog {
    ...
    public static final String MEGABASTERD_URL = "https://github.com/Bilibox/megabasterd/releases/latest";
    ...
    private void initComponents() {
        ...
        subtitle_label
                .setText("Yet another unofficial (and ugly) cross-platform MEGA downloader/uploader/streaming suite.");
        ...
        check_version_button
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-restart-30.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup().addContainerGap()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(subtitle_label, javax.swing.GroupLayout.DEFAULT_SIZE,
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                        layout.createSequentialGroup().addComponent(mb_label)
                                                                .addGap(18, 18, 18).addComponent(mc_logo_label))
                                                .addComponent(author_webpage_label,
                                                        javax.swing.GroupLayout.Alignment.TRAILING)))
                                .addGroup(layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(
                                        java_version, javax.swing.GroupLayout.PREFERRED_SIZE, 481,
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup().addGap(9, 9, 9)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(mcdown_url_button).addComponent(check_version_button))))
                        .addGap(18, 18, 18).addComponent(subtitle_label)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(made_in_spain_label).addComponent(dot_com_label)
                                .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                .addComponent(mb_label).addComponent(mc_logo_label))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(author_webpage_label)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(java_version)
                        .addContainerGap()));
    ...
    private void check_version_buttonActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_check_version_buttonActionPerformed
        ...
        final String old_check_version_button_text = check_version_button.getText();
        ...
        THREAD_POOL.execute(() -> {
            ...
            swingInvoke(() -> {
                if (new_version != null) {
                    ...
                    JOptionPane.showMessageDialog(tthis, LabelTranslatorSingleton.getInstance()
                            .translate("MegaBasterd NEW VERSION is available! -> ") + new_version);
                    ...
                    JOptionPane.showMessageDialog(tthis,
                            LabelTranslatorSingleton.getInstance().translate("You have the latest version ;)"));
    ...
    private void subtitle_labelMouseReleased(final java.awt.event.MouseEvent evt) {// GEN-FIRST:event_subtitle_labelMouseRele
