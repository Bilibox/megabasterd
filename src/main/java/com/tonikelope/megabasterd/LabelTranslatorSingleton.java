...
public class LabelTranslatorSingleton {
    ...
    private void Spanish() {
        ...
        _addTranslation("Execute this command when MEGA download limit is reached:",
                "Ejecutar este comando cuando se alcance el límite de descarga de MEGA:");
        _addTranslation(
        ...
        _addTranslation(
                "Finishing calculating CBC-MAC code (this could take a while) ... ***DO NOT EXIT MEGABASTERD NOW***",
