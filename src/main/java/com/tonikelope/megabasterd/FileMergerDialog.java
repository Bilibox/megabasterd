...
public class FileMergerDialog extends javax.swing.JDialog {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup().addContainerGap()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup().addComponent(delete_parts_checkbox).addGap(0,
                                        0, Short.MAX_VALUE))
                                ...
                                .addComponent(jProgressBar2, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(merge_button, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                .createSequentialGroup().addContainerGap().addComponent(file_button).addGap(9, 9, 9)
                .addComponent(file_name_label).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(file_size_label).addGap(18, 18, 18).addComponent(output_button)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(output_folder_label)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jProgressBar2, javax.swing.GroupLayout.PREFERRED_SIZE, 36,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, Short.MAX_VALUE).addComponent(delete_parts_checkbox)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(merge_button)
                .addContainerGap()));
    ...
    private void file_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_file_buttonActionPerformed
        ...
        if (filechooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION
            ...
            this._file_name = MiscTools.findFirstRegex("^(.+)\\.part[0-9]+\\-[0-9]+$",
                    filechooser.getSelectedFile().getName(), 1);

            if (this._file_name != null) {

                this.file_name_label.setText(truncateText(
                        filechooser.getSelectedFile().getParentFile().getAbsolutePath() + "/" + this._file_name, 100));

                this.file_name_label.setToolTipText(
                        filechooser.getSelectedFile().getParentFile().getAbsolutePath() + "/" + this._file_name);

                this.output_folder_label
                        .setText(truncateText(filechooser.getSelectedFile().getParentFile().getAbsolutePath(), 100));

                this.output_folder_label
                        .setToolTipText(filechooser.getSelectedFile().getParentFile().getAbsolutePath());
                    ...
                    if (_mergeFile()) {
                        ...
                        swingInvoke(() -> {
                            JOptionPane.showMessageDialog(tthis,
                                    LabelTranslatorSingleton.getInstance().translate("File successfully merged!"));
