...
public class GetMasterPasswordDialog extends javax.swing.JDialog {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createSequentialGroup().addComponent(lock_label)
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(layout.createSequentialGroup().addComponent(remember_checkbox)
                                                        .addGap(0, 0, Short.MAX_VALUE))
                                                .addComponent(please_label, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                .createSequentialGroup().addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup().addComponent(please_label)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(current_pass_textfield, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void ok_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ok_buttonActionPerformed
        ...
        THREAD_POOL.execute(() -> {
            try {
                byte[] pass = CryptTools.PBKDF2HMACSHA256(new String(current_pass_textfield.getPassword()),
                ...
                swingInvoke(() -> {
                    if (!pass_hash.equals(_current_pass_hash)) {
                        ...
                        JOptionPane.showMessageDialog(tthis,
                                LabelTranslatorSingleton.getInstance().translate("BAD PASSWORD!"), "Error",
